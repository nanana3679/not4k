...
- **가장 이른 매칭**: 규칙의 정식 이름은 **keydown 소비 / keyup 소비**(RFD 0015 2규칙, 약칭 R1/R2 — 쌍으로 부를 때만 사용)다. "가장 이른 매칭"은 그 규칙 동작의 *서술*로 한국어를 유지한다. `earliest`는 지역 변수명일 뿐 개념 캐논이 아님 (2026-07-06 A에서 제외).
