...
- 1/3 ↔ 3/1 전환 시 건너가기 방향이 반전되므로(오른손 L2 → 왼손 L3), 인식 난이도가 매우 높다. 상급(Lv.11~13) 피스이다.
...
| 트릴 앵커 + 건너가기 + 가변 분할 | PLv.11 | 상급 | 1/3 배치. 반대 손이 내측 레인까지 담당 |
| 가변 분할 전환 | PLv.11 | 상급 | 1/3 ↔ 2/2 ↔ 3/1 전환. 건너가기 방향이 바뀜 |
