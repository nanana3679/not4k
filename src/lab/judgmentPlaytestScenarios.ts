/**
 * 판정 실플레이 시나리오 (DEV 전용 lab) — RFD 0019 채택 판정 모델 실측용.
 *
...
export const PLAYTEST_SCENARIOS: PlaytestScenario[] = [
  {
    id: "connected-single-swap", label: "o-o- · 유지와 교대", ref: "RFD 0019",
  ...
  {
    id: "connected-double-swap", label: "d=d= · 두 키 유지와 전체 교대", ref: "RFD 0019",
  ...
  {
    id: "single-head-double-connection", label: "=o= · 한 몫만 교대", ref: "RFD 0019",
  ...
  {
    id: "decrease-chain", label: "=-=- · 실제 감소 두 번", ref: "RFD 0019",
  ...
  {
    id: "holdonly-decrease-chain", label: "감소 holdOnly · 두 키 계속 유지", ref: "RFD 0019",
  ...
  {
    id: "failure-recovery", label: "중간 실패 · 다음 헤드부터 복구", ref: "RFD 0019",
  ...
  {
    id: "partial-double-head", label: "더블 헤드 하나만 입력", ref: "RFD 0019",
  ...
  {
    id: "same-key-short-connection", label: "같은 키 재타격 · 가까운 마지막 release", ref: "RFD 0019",
  ...
  {
    id: "independent-holdonly-start", label: "독립 holdOnly · 미리 잡은 키와 새 입력", ref: "RFD 0019",
  ...
  {
    id: "late-holdonly-start", label: "60ms holdOnly · 끝난 뒤 첫 활성화", ref: "RFD 0019",
  ...
  {
    id: "holdonly-then-slide", label: "길이 0 holdOnly · 기존 held로 통과", ref: "RFD 0019",
  ...
  {
    id: "timeout-then-slide", label: "앞 release Miss · 길이 0은 독립 판정", ref: "RFD 0019",
  ...
  ...([1, 2, 4] as const).map((denominator): PlaytestScenario => {
    ...
    return {
      ...
      label: `홀드 트릴 체인 · ${intervalMs}ms 간격`, ref: "RFD 0019",
