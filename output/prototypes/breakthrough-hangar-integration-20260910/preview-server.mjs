...
const files=new Map();
for(const name of ["index.html", "style.css", "scene.mjs", "extensions/a-wedge.mjs", "extensions/b-maintenance.mjs", "extensions/c-service-tower.mjs", "extensions/d-twin-gallery.mjs", "extensions/f-open-dock.mjs", "extensions/g-transfer-spine.mjs", "extensions/h-logistics-hub.mjs", "integration.mjs", "world-trails.mjs", "light-batch.mjs", "render-model.mjs", "surface-geometry.mjs", "originals/hangar.mjs", "vendor/three.module.js", "vendor/three.core.js", "vendor/LICENSE", "legacy/geometry.mjs", "legacy/architecture.mjs", "legacy/original-motion.mjs", "legacy/palette.mjs", "legacy/surface-art.mjs", "legacy/wall-contours.mjs", "legacy/clearance.mjs", "legacy/afterglow.mjs", "model-library.mjs", "surroundings.mjs", "painted-backdrop.mjs", "catalog.mjs", "blueprint-kit.mjs", "originals/wedge.mjs", "modules/d-twin-gallery.mjs", "modules/f-open-dock.mjs", "modules/c-service-tower.mjs", "modules/e-hangar.mjs", "modules/b-maintenance.mjs", "modules/h-logistics-hub.mjs", "modules/g-transfer-spine.mjs", "modules/a-wedge.mjs"]){const type=name.endsWith('.html')?'text/html; charset=utf-8':name.endsWith('.css')?'text/css':name.endsWith('.mjs')||name.endsWith('.js')?'text/javascript':'text/plain';files.set(name,{bytes:await readFile(new URL(name,import.meta.url)),type});}
