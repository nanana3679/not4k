// Isolated comparison: frozen original light math, rigid E placement, shared projection.
...
export function collectFaces(lights,travel,s,p,view){
 ...
 for(const light of lights)for(const face of worldFaces(light,travel,s,p)){
