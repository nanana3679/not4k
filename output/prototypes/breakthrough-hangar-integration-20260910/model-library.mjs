...
export function createModelLibrary(textures){
 ...
 for(const module of modules){
  const family=module.metadata.id==='A'?'wedge':'standard';
  const model=applyArchitecturalMaterials(buildModel(module.createBlueprint(),textures,family),textures,family);
